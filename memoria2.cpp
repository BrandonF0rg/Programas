...
int main(){
	...
	cout<<"la diferencia del primer elemento es: "<<edades<<endl;
	...
	cout<<"el valor del aexto elemento es: "<<*(edades+5)<<endl<<endl;
...
cout<<"el valor del segundo elemento es: "<< *(ptrc+3)<<endl<<endl;

cout<<"la direccion del segundo elemento es: "<< &ptrc+4 <<endl;
cout<<"el valor del segundo elemento es: "<< *(ptrc+4)<<endl<<endl;
